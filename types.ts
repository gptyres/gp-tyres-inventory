...
export type SupplierCatalog = 'ALL_SUPPLIERS' | 'SAILUN' | 'EXCLUSIVE_TYRES' | 'TYREWAREHOUSE' | 'ATT' | 'SAFETY_GRIP' | 'ALINE' | 'STAMFORD' | 'TREAD_ZONE' | 'TYRE_LIFE_WHEELS' | 'TREADS_UNLIMITED' | 'TYRE_LIFE' | 'APEX' | 'TUBESTONE';
